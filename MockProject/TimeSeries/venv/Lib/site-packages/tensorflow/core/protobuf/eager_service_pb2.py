...
_CREATECONTEXTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rendezvous_id', full_name='tensorflow.eager.CreateContextRequest.rendezvous_id', index=4,
