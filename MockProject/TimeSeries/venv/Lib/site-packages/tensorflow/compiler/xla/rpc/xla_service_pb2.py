...
_XLASERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ExecuteGraph',
    full_name='xla.XlaService.ExecuteGraph',
    index=14,
    containing_service=None,
    input_type=tensorflow_dot_compiler_dot_xla_dot_xla__pb2._EXECUTEGRAPHREQUEST,
